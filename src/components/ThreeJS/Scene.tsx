...
const Scene = ({
  ...
  useFrame(() => {
    ...
    if (bootup) {
      setDialog(
        "Finally, you decided to start my tour. Welcome to my portfolio. My name is Adam Turaj. Here you will step through my life creating things. Lets begin with the bootup of my computer..."
      );
